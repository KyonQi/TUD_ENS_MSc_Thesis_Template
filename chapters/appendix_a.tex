...
These results demonstrate that \emph{ours}, with the proposed mechanisms, consistently outperforms the \emph{baseline} across all evaluated metrics, except for peak worker memory usage, which is inherently higher due to the nature of convolutional computation.
...
\begin{figure}[t]
    \centering
      ...
      \end{subfigure}
      % \hfill
  \caption{Communication overhead across 2 to 6 MCUs for the four evaluated models.}
...
\begin{figure}[t]
    \centering
      ...
      \end{subfigure}
      % \hfill
  \caption{The peak memory usage at the coordinator across 2 to 6 MCUs for the four evaluated models.}
...
\begin{figure}[t]
    \centering
      ...
      \end{subfigure}
      % \hfill
  \caption{The peak memory usage at the workers across 2 to 6 MCUs for the four evaluated models.}
